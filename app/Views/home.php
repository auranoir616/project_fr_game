...
<div class="flex flex-col md:flex-row justify-between items-start max-md:flex-col ">
    <div class="flex flex-col justify-start items-start w-full md:w-1/3 p-5">
        <?= view('/components/home/_animasiCode1') ?>
        <?= view('/components/home/_displayIP') ?>
    </div>
    <div class="flex flex-col justify-start items-center  w-full md:w-1/3 p-5 order-first md:order-none">
        <?= view('/components/home/_dropdowngame') ?>
        <?//= view('/components/home/_animasibar') ?>
        <?= view('/components/home/_loginForm') ?>
    </div>
    <div class="flex flex-row justify-start items-start w-full md:w-1/3 p-5">
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div class="windowForm">
            <div class="flex items-center justify-between p-4 md:p-5 rounded-t">
                <h3 class="font text-3xl">Running</h3>
            </div>
            ...
            <div class="flex items-center justify-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                <a class="btn-glow w-1/2 fontBar text-center font-bold h-10 justify-center items-center hidden"  href="<?php echo $dataurl[0]['link_url_redirect']; ?>" id="buttonLogin" data-modal-hide="static-modal">Login</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="w-11/12 h-80">
            ...
            <div class="w-full min-h-80 window" id="runningProgram">
                <pre id="Running-Programs" class="font" style="white-space: pre-wrap;"></pre>
            </div>
        </div>
    </div>
</div>
<?= view('/components/home/_footer') ?>
